  ...
  return (
    <section className="block fixed bottom-0 inset-x-0 z-50 shadow-lg text-black-800 bg-slate-100 dark:bg-dark backdrop-blur-lg bg-opacity-70  border-t-2 border-royal/20 ">
      <div id="tabs" className="flex justify-between">
        ...
        <NavLink
          to={"/"}
          className="w-full focus:text-royal hover:text-royal justify-center inline-block text-center pt-2 pb-1 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 hover:text-white"
